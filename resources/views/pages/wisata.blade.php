        ...
        @php
            ...
            $slideImages = $sites
                ...
                ->map(
                    ...
                    ? asset($s->image_path)
                    : url('/download-file?path=' . $s->image_path)
                )
                ->values()
                ->toArray();
                    ...
                    @foreach($sites->where('category', 'sejarah') as $site)
                        ...
                        <div
                            ...
                            <div class="relative h-64 overflow-hidden">
                                ...
                                <img src="{{ empty($site->image_path) ? asset('images/dummy/wisata1.jpg') : (Str::startsWith($site->image_path, 'images/dummy/') ? asset($site->image_path) : url('/download-file?path=' . $site->image_path)) }}"
                                    alt="{{ $site->name }}"
                        ...
                        <div
                            ...
                            <div class="w-full md:w-1/2">
                                <div class="relative rounded-3xl overflow-hidden shadow-2xl group">
                                    ...
                                    <img src="{{ empty($site->image_path) ? asset('images/dummy/tradisi1.jpg') : (Str::startsWith($site->image_path, 'images/dummy/') ? asset($site->image_path) : url('/download-file?path=' . $site->image_path)) }}"
                                        alt="{{ $site->name }}"
                            ...
                            <div class="w-full md:w-1/2 space-y-4">
                                <h3
                                    ...
                                    {{ $site->name }}</h3>
                                <p
                                    class="font-body-md text-on-surface-variant text-lg leading-relaxed text-justify line-clamp-4">
