            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div class="bg-surface-container-lowest rounded-2xl overflow-hidden shadow-sm border border-outline-variant/30 group hover:shadow-lg transition-all flex flex-col">
                    ...
                    <div class="p-5 flex-grow flex flex-col">
                        ...
                        @php
                            $beritaDesc = preg_replace('/\s+/', ' ', trim(strip_tags(
                                preg_replace('/<\/(p|li|h[1-6]|div|td|th|tr)>/i', ' ',
                                    str_replace(['<br>', '<br/>', '<br />'], ' ', $berita->content)
                                )
                            )));
                        @endphp
                        <p class="font-body-sm text-on-surface-variant text-left line-clamp-2 mb-4 break-words min-w-0">{{ $beritaDesc }}</p>
