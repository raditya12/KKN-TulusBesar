                    ...
                    >
                        @if($hasMultiple)
                            ...
                            <div class="absolute inset-0 transition-opacity duration-1000 ease-in-out"
                                ...
                                <img src="{{ Str::startsWith($img, 'images/dummy/') ? asset($img) : asset('storage/' . $img) }}" alt="{{ $wisata->name }} - Slide {{ $index + 1 }}" class="w-full h-full object-cover">
                            </div>
                            @endforeach
